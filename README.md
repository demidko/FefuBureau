...
# Цели нашего проекта:
  * Основной целью нашего проекта является создание децентрализованной, автообновляемой и самоподдерживаемой системы корпоративных контактов, одновременно являющейся справочником с полной информацией о каждом интересующем вас должностном лице. Отсюда и происходит название нашего сервиса.
  * Мы хотим дать возможность найти любого сотрудника ДВФУ, а в будущем и других сопутствующих организаций. До сих пор не существовало сайта или приложения с возможностью получить полные сведения о сотруднике, услышав его имя или должность. Теперь будет, и это поможет как первокурсникам, так и студентам которые учатся не первый год, и даже самим работникам университета.
