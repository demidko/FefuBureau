...
Бюро ДВФУ - это сервис который даёт доступ к нужным общедоступным сведениям о преподавателях и других сотрудниках ДВФУ. Сервис не знанимается обработкой персональных данных, за исключением общедоступных.
# Цели нашего проекта:
  * Сейчас основной целью нашего проекта является создание децентрализованной, автообновляемой и самоподдерживаемой системы корпоративных контактов, одновременно являющейся справочником с полной информацией о каждом интересующем вас сотруднике университета. Отсюда и происходит название нашего сервиса.
